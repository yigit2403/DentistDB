(function () {
  ...
  /* ---------------------------------------------------------------------
     Turkish number parsing: accept "1.250,50", "1250,50" and "1250.50".
     Defined unconditionally so page scripts (invoice form, plan form) can use it.
     --------------------------------------------------------------------- */
  ...
  /* ---------------------------------------------------------------------
     ...
     jquery.validate loads after this file (in the Scripts section), so the
     setup runs once the DOM (and all synchronous scripts) are ready.
     --------------------------------------------------------------------- */
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", setupValidator);
  } else {
    setupValidator();
  }
